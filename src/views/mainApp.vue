<template>
    ...
    <div class="dash" v-if="!userLogedIn">
        <div class="dash-nav dash-nav-dark">
            ...
            <nav class="dash-nav-list">
                <a href="index.html" class="dash-nav-item"><router-link to="/app">
                    <i class="fas fa-home"></i>Dashboard </router-link> </a>
                <div class="dash-nav-dropdown">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                        <i class="fas fa-user"></i> Employee </a>
                    <div class="dash-nav-dropdown-menu">
                        <a class="dash-nav-dropdown-item"><router-link to="/app/user">Create Employee</router-link></a>
                          <a class="dash-nav-dropdown-item"> <router-link to="/app/employeelist">Employee list </router-link></a>
                    </div>
                </div>
                <div class="dash-nav-dropdown ">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                  <i class="fas fa-store"></i> Purchase Item</a>
                    <div class="dash-nav-dropdown-menu">
                        <a class="dash-nav-dropdown-item"><router-link to="/app/addpurchase"> Purchase</router-link></a>
                        <a  class="dash-nav-dropdown-item"><router-link to="/app/purchaselist">Purchase History</router-link></a>
                        <!-- <div class="dash-nav-dropdown ">
                ...
                <div class="dash-nav-dropdown">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                        <i class="fa fa-plane"></i> Leave tracking </a>
                    <div class="dash-nav-dropdown-menu">
                        <a class="dash-nav-dropdown-item"><router-link to="/app/leavesetting">   Request</router-link></a>
                         <a  class="dash-nav-dropdown-item"><router-link to="/app/leavelist"> List</router-link> </a>
